   ...
   public class GTC_Level1 : Microsoft.Xna.Framework.Game
   {
      ...
      protected override void Update(GameTime gameTime)
      {
         ...
         if (currentGameState != GameStates.Lose && currentGameState != GameStates.Win)
         {
            ...
            if (player.candyCount == 15 && guards[2].isFollowPathNull ())
            {
            ...
            if (player.candyCount == 25 && guards[3].isFollowPathNull ())
            {
            ...
            if (player.candyCount == 40 && guards[4].isFollowPathNull ())
            {
            ...
            if (player.candyCount == 10 && mothers[1].isTempPathNull())
            {
               mothers[1].setTempPath (momExitPath, true);
            }

            if (player.candyCount == 20 && mothers[2].isTempPathNull ())
            {
               mothers[2].setTempPath (momExitPath, true);
            }

            if (player.candyCount == 30 && mothers[3].isTempPathNull ())
            {
               mothers[3].setTempPath (momExitPath, true);
            }

            if (player.candyCount == 35 && mothers[4].isTempPathNull ())
            {
